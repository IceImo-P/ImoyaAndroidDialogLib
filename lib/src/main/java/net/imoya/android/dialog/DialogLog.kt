...
/**
 * Log for ImoyaAndroidDialogLib
 *
 * * Interfaces are compatible with [android.util.Log].
 * * If you will setup minimum output log level for ImoyaAndroidDialogLib,
 *   set string resource named "imoya_android_dialog_log_level" and call [init] on
 *   created application or activity.
 *
 * @author IceImo-P
 */
@Suppress("unused")
object DialogLog : StaticLogTemplate(LogLevel.NONE) {
    /**
    ...
    fun init(context: Context) {
        super.init(context, R.string.imoya_android_dialog_log_level)
    }
